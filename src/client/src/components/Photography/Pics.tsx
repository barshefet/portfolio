  ...
  return (
    <div className="grid-container">
      <div className="column">
        ...
        <img src="images/photographs/5.jpg" className="img5" alt="" />
        <img src="images/photographs/6.jpg" className="img6" alt="" />
      </div>
      <div className="column">
        <img src="images/photographs/7.jpg" className="img7" alt="" />
        <img src="images/photographs/4.png" className="img4" alt="" />
      ...
      <img src="images/photographs/29.jpg" className="img11" alt="" /> */}
    </div>
  );
};
